...
import { ReactionSettings } from "./Constants"
...
class ReactionRateChartLayoutSettings {
    ...
    constructor(chartSize: number, minConcentration?: number, maxConcentration?: number, minTime?: number, maxTime?: number, includeAxisPadding?: boolean) {
        this.chartSize = chartSize
        this.minConcentration = minConcentration ? minConcentration : ReactionSettings.Axis.minC
        this.maxConcentration = maxConcentration ? maxConcentration : ReactionSettings.Axis.maxC
        this.minTime = minTime ? minTime : ReactionSettings.Axis.minT
        this.maxTime = maxTime ? maxTime : ReactionSettings.Axis.maxT
